...
class Producer extends Kafka {
     ...
     * @return type
     */
    public function queue(array $msg, $key = null, $partition = 0) {
        return $this->pro_topic->produce($partition, 0, serialize($msg), $key);
    }
     ...
     * @return type
     */
    public function queueCall($class, $method, array $args, $key = null, $partition = 0) {
